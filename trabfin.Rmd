...
<p> O tratmento dos valores omissos começou com tornar os valores em brancos para 99, no R nós passamos os valores em null, todas as variaveis relacionadas com ansiedade como "v38_ansiedade", "v40_ansiedade", "v43_ansiedade","v45_ansiedade","v51_ansiedade","v55_ansiedade","v56_ansiedade"

O tratamento dos valores omissos fez-se em vários passos. Primeiro, os valores em branco foram alterados para um código (99) que é representativo das mesmas. Para a nossa análise, reparámos que as variáveis “Onde vive”, “Transportes públicos”, “Produtos pelo ambiente”, “Apagar as luzes” e “Fechar a torneira” tinham uma grande quantidade de respostas nulas, por esse motivo realizou-se uma imputação dos valores inexistentes pela mediana das respostas.

Neste ponto foram atribuídos valores numéricos a variáveis de texto e valores texto a variáveis numéricas, sendo que no caso de resposta em branco foi atribuído anteriormente o valor 99.</p>
