...
<center>**Tabela 1** - Distribuição por sexos</center>
...
# Criar o gráfico de lollipop
ggplot(data, aes(x = specie, y = value, color = condition)) + 
  # Adicionando as linhas do lollipop
  geom_segment(aes(x = specie, xend = specie, y = 0, yend = value), size = 1) +
