...
<p>Em termos de distribuição por idades (**Tabela
2**).</p>
...
plot_idade <- ggplot(bd, aes(x = P3)) +
  ...
  labs(title = "Distribuição de Idades (Valores Inteiros)", x = "Idade", y = "Contagem") +
  theme_minimal()
...
<center>**Gráfico 1 e 2** - Distribuição por da popução inquirida entre ciclo escolar e idade</center>
